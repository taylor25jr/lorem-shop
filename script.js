...
function addItemToShoppingCart(tittle,price,img){
 ...
 for (let i = 0; i < elementsTitle.length; i++) {
    if(elementsTitle[i].innerText === tittle) { let elementQuantity = elementsTitle[i].parentElement.parentElement.parentElement.querySelector('.shoppingCartItemQuantity');
